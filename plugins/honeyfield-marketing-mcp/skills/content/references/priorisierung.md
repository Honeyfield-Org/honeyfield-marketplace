...
- Wie besetzt ist die SERP (`dfs_serp_google_organic`, Difficulty-Proxy — **keine Difficulty-Zahl**)?
- Long-Tail-Chancen drumherum?
- Interesse steigend oder fallend?
...
Themen der Buyer-Journey zuordnen — der Modifier verrät den Intent und den passenden Content-Typ:
...
1. Jedes Gap-Thema um die für die Erstellung fehlenden Felder ergänzen: Volumen/CPC (`dfs_keyword_volume`), Buyer-Stage (Modifier oben), Pillar-Fit.
